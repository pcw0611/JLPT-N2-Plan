# -*- coding: utf-8 -*-
"""Record Anki study stats and study session for 2026-09-24."""
...
TEMP_DIR = Path(r'C:\Users\pcw06\AppData\Local\Temp\anki_inspect_0924')
...
s_dt = datetime(2026, 9, 24, 4, 0, 0, tzinfo=KST)
e_dt = datetime(2026, 9, 25, 4, 0, 0, tzinfo=KST)
...
SUMMARY_PAYLOAD = {
    ...
    'sourceNote': (
        ...
        f'N2 집중 회독 1,360회(395장, 125.3분 / 2시간 5분 16초, 1,169장 전량 1차 완독 회독 유지). '
        f'N3 366회(144장, 32.6분), N4 35회(21장, 2.4분), N5 30회(19장, 2.2분), '
        f'공통 의성어/의태어 11회(7장, 0.7분), 공통 의상 2회(2장, 0.1분).'
    ),
    'inventory': {
        'n3_unseen': 0,
        'n2_unseen': 0,
...
SESSION_SUMMARY = (
    ...
    f"1) JLPT 한끝 Voca 4-N2 고밀도 회독 1,360회(395장, 125.3분 / 2시간 5분 16초, 1,169장 1차 완독 전량 회독 유지). "
    f"2) N3 366회(144장, 32.6분), N4 35회(21장, 2.4분), N5 30회(19장, 2.2분), "
    f"공통 의성어·의태어 11회(7장, 0.7분), 공통 의상 2회(2장, 0.1분) 복습 유지. "
