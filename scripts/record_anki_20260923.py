# -*- coding: utf-8 -*-
"""Record Anki study stats and study session for 2026-09-23."""
...
TEMP_DIR = Path(r'C:\Users\pcw06\AppData\Local\Temp\anki_inspect_0923')
...
s_dt = datetime(2026, 9, 23, 4, 0, 0, tzinfo=KST)
e_dt = datetime(2026, 9, 24, 4, 0, 0, tzinfo=KST)
...
SUMMARY_PAYLOAD = {
    ...
    'sourceNote': (
        ...
        f'N2 집중 회독 1,204회(317장, 267.8분 / 4시간 28분, 1,169장 전량 1차 완독 회독 유지). '
        f'N3 235회(103장, 37.6분), N4 23회(17장, 3.3분), N2 문법 예문 18회(16장, 3.5분), N5 18회(13장, 2.1분), '
        f'공통 의상 16회(8장, 2.0분), 공통 의성어/의태어 5회(5장, 0.5분).'
    ),
    'inventory': {
        'n3_unseen': 0,
        'n2_unseen': 0,
...
SESSION_SUMMARY = (
    ...
    f"1) JLPT 한끝 Voca 4-N2 고밀도 회독 1,204회(317장, 267.8분 / 4시간 28분, 1,169장 1차 완독 전량 회독 유지). "
    f"2) N3 235회(103장, 37.6분), N4 23회(17장, 3.3분), N2 문법 001-150 예문 복습 18회(16장, 3.5분), N5 18회(13장, 2.1분), "
    f"공통 의상 16회(8장, 2.0분), 공통 의성어·의태어 5회(5장, 0.5분) 복습 유지. "
