# -*- coding: utf-8 -*-
"""Record Anki study stats and study session for 2026-09-26."""
...
TEMP_DIR = Path(r'C:\Users\pcw06\AppData\Local\Temp\anki_inspect_0926')
...
s_dt = datetime(2026, 9, 26, 4, 0, 0, tzinfo=KST)
e_dt = datetime(2026, 9, 27, 4, 0, 0, tzinfo=KST)
...
SUMMARY_PAYLOAD = {
    ...
    'sourceNote': (
        ...
        f'N2 집중 회독 351회(112장, 58.1분 / 3,485.6초, 1,169장 1차 완독 전량 회독 유지). '
        f'N3 29회(17장, 2.6분), N5 12회(7장, 0.9분), N4 3회(2장, 0.5분), '
        f'공통 의성어/의태어 2회(1장, 0.1분).'
    ),
    'inventory': {
        'n3_unseen': 0,
        'n2_unseen': 0,
...
SESSION_SUMMARY = (
    ...
    f"Anki 단어 세션 {cnt:,}회 실측 (심야 02:08 완수, 고유 카드 {distinct_cards}장, 카드당 평균 {sec_per_card}초): "
    f"1) JLPT 한끝 Voca 4-N2 고밀도 회독 351회(112장, 58.1분 / 3,485.6초, 1,169장 1차 완독 전량 회독 유지). "
    f"2) N3 29회(17장, 2.6분), N5 12회(7장, 0.9분), N4 3회(2장, 0.5분), "
    f"공통 의성어·의태어 2회(1장, 0.1분) 복습 유지. "
