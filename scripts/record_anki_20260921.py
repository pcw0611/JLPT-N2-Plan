# -*- coding: utf-8 -*-
"""Record Anki study stats and study session for 2026-09-21."""
...
TEMP_DIR = Path(r'C:\Users\pcw06\AppData\Local\Temp\anki_inspect_0921')
...
s_dt = datetime(2026, 9, 21, 4, 0, 0, tzinfo=KST)
e_dt = datetime(2026, 9, 22, 4, 0, 0, tzinfo=KST)
...
SUMMARY_PAYLOAD = {
    ...
    'sourceNote': (
        ...
        f'N2 집중 회독 2,021회(427장, 277.4분, 1,169장 전량 1차 완독 회독 유지). '
        f'N3 433회(152장, 53.5분), N4 56회(30장, 4.3분), N5 42회(22장, 3.9분), N2 문법 예문 21회(21장, 4.4분), 공통 의상 14회(9장, 1.2분), 공통 의성어/의태어 9회(5장, 0.7분).'
    ),
    'inventory': {
        'n3_unseen': 0,
        'n2_unseen': 0,
...
SESSION_SUMMARY = (
    ...
    f"1) JLPT 한끝 Voca 4-N2 고밀도 회독 2,021회(427장, 277.4분 / 4시간 37분, 1,169장 1차 완독 전량 회독 유지). "
    f"2) N3 433회(152장, 53.5분), N4 56회(30장, 4.3분), N5 42회(22장, 3.9분), N2 문법 001-150 예문 복습 21회(21장, 4.4분), 공통 의상 14회(9장, 1.2분), 공통 의성어·의태어 9회(5장, 0.7분) 복습 유지. "
