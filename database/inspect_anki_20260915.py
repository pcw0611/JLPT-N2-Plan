# -*- coding: utf-8 -*-
"""Inspect Anki reviews and calculate statistics for 2026-09-15 study day."""
import sqlite3
import shutil
import json
import os
...
start_dt = datetime(2026, 9, 15, 4, 0, 0, tzinfo=KST)
end_dt = datetime(2026, 9, 16, 4, 0, 0, tzinfo=KST)
...
rows = cur.fetchall()
print(f'Total reviews for 2026-09-15 study day: {len(rows)}')
